...
class kNNEmbeddingEngine(EmbeddingEngine):
  """Extends embedding engine to also provide kNearest Neighbor detection.
     ...
     functions to query with a new query embedding and find nearest neighbors.
  """
  ...
  def addEmbedding(self, emb, label):
    ...
    # examples. Otherwise blocks that hav more examples unfairly win.
    emb_blocks = []
